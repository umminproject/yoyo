...
public class HomeController {
	...
	public String resultPage(Locale locale, Model model) {
		...
		return "layout/result_page";
	}
	@RequestMapping(value = "/consultingRecord", method = RequestMethod.GET)
	public ModelAndView consultingRecord(HttpServletResponse response, 
			HttpServletRequest request) throws Exception {
		BoardDao dao = sqlSession.getMapper(BoardDao.class);
		HttpSession session = request.getSession();
		String b_id = (String) session.getAttribute("sessionid");
		ArrayList<Board> board = dao.boardSelectCon(b_id);
	...
	public ModelAndView counselinglist(HttpServletResponse response, 
		HttpServletRequest request) throws Exception {
		BoardDao dao = sqlSession.getMapper(BoardDao.class);
		HttpSession session = request.getSession();
		String b_id = (String) session.getAttribute("sessionid");
