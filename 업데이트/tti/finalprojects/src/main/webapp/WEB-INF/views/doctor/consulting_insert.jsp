	...
	<body>
		<!-- MAIN -->
			<div class="wrapper cf">
				...
				<!-- form -->
				<form class="form" id="contactForm" action="noticeInsert" method="post" data-parsley-validate="true" role="form">
						 <p>
						 <input type="hidden" value="${b_dept}" id="b_dept" name="b_dept"/>
						</p>
