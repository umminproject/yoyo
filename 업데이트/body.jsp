			...
			<div class="wrapper">
				...
				<div id="home-slider" class="lof-slidecontent">
					...
					<ul class="sliders-wrap-inner">
					    <li>
					          <img src="resources/img/ll.gif" title="" alt="alt" />           
					    ...
					    <li>
					          <img src="resources/img/upload/hyunjin2.jpg" title="" alt="alt" />           
					          <div class="slider-description">
					            <h4>Lorem ipsum dolor</h4>
					            <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est...
					            <a class="link" href="#">Read more </a>
					...
					<div class="navigator-content">
					  <div class="navigator-wrapper">
					        <ul class="navigator-wrap-inner">
					           <li><img src="resources/img/upload/hyunjin3.jpg" alt="alt" /></li>
		...
		<div id="main" style="background-color:#fff">
			...
			<div class="home-featured">
				...
				<div id="filter-container" class="cf">
					<figure class="web">
						<a href="project.html" class="thumb"><img src="resources/img/q.jpeg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="print">
						<a href="project.html" class="thumb"><img src="resources/img/qq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="design">
						<a href="project.html" class="thumb"><img src="resources/img/qqq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="photo">
						<a href="project.html" class="thumb"><img src="resources/img/qqqq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="web photo">
						<a href="project.html" class="thumb"><img src="resources/img/qqqqq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="web print">
						<a href="project.html" class="thumb"><img src="resources/img/qqqqqq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="photo">
						<a href="project.html" class="thumb"><img src="resources/img/qqqqqqq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="web photo">
						<a href="project.html" class="thumb"><img src="resources/img/qqqqqqqq.jpg" alt="alt" /></a>
						<figcaption>
					...
					<figure class="web print">
						<a href="project.html" class="thumb"><img src="resources/img/qqqqqqqqqq.jpg" alt="alt" /></a>
						<figcaption>
