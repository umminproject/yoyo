...
<body>
	<form action="memberDelete" method="post">
		<div class="container">
			...
			<div class="row">
				<button type="submit" class="col-md-offset-4 col-md-4 btn btn-success resultButton"
				name="delete" id="delete">확인</button>
			</div>
			<div class="row">
				<button type="button" class="col-md-offset-4 col-md-4 btn btn-success resultButton"
				name="cancel" id="cancel" onclick="location.href='member_list'">취소</button>
			</div>
